 ...
 */
// Tokyo (ap-northeast-1) deployment uses jp.* / global.* inference profiles.
// - jp.* preferred for in-region routing (lowest latency)
// - global.* fallback for models without a jp.* profile (e.g. Opus 4.6)
export const ANTHROPIC_TO_BEDROCK_MODEL_MAP: Record<string, string> = {
  ...
  'claude-sonnet-4': 'jp.anthropic.claude-sonnet-4-20250514-v1:0',
};
