...
// The workspace S3 bucket lives in the same region as the deployment stack
// (default ap-northeast-1 for Tokyo). Override via WORKSPACE_S3_REGION env
// var if the bucket is provisioned in a different region.
const S3_REGION = process.env.WORKSPACE_S3_REGION ?? process.env.AWS_REGION ?? 'ap-northeast-1';
